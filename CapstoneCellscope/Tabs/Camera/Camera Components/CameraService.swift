...
extension Photo {
    public var compressedData: Data? {
        ImageResizer(targetWidth: 800).resize(data: originalData)?.jpegData(compressionQuality: 0.25)
    }
    public var thumbnailData: Data? {
        ImageResizer(targetWidth: 100).resize(data: originalData)?.jpegData(compressionQuality: 0.25)
    }
    ...
    public func capturePhoto() {
        if self.setupResult != .configurationFailed {
            ...
            sessionQueue.async {
                ...
                //Added this for quality priozitation
